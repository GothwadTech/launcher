...
fun SetupWizard(onDone: () -> Unit, onVpnChosen: (String?) -> Unit) {
    ...
    var isA11yActive by remember { mutableStateOf(com.gothwad.launcher.service.LauncherAccessibilityService.isEnabled(context)) }
    var isNotifActive by remember { mutableStateOf(com.gothwad.launcher.service.NotificationManagerBridge.isNotificationAccessGranted(context)) }
    ...
    val roleLauncher = rememberLauncherForActivityResult(
        ...
        isA11yActive = com.gothwad.launcher.service.LauncherAccessibilityService.isEnabled(context)
    }

    fun checkStatus() {
        defaultHome = defaultHomePackage(context)
        isA11yActive = com.gothwad.launcher.service.LauncherAccessibilityService.isEnabled(context)
        isNotifActive = com.gothwad.launcher.service.NotificationManagerBridge.isNotificationAccessGranted(context)
    }
                    ...
                    if (isDefault) {
                        ...
                        when (gtvPage) {
                            ...
                            1 -> {
                                ...
                                CodeLine("adb shell cmd package set-home-activity com.gothwad.launcher/.MainActivity")
